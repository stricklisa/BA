...
\subsubsubsection{24-Stunden Erinnerungsprotokoll}
...
\textbf{Feasibility of a SenseCam-assisted 24-h recall to reduce under-reporting of energy intake (Gemming et al. 2013)}\\
...
\textbf{Validity of the RFPM for estimating energy and nutrient intake in near real-time (Martin et al. 2012)}\\
...
\textbf{Comparison of Known Food Weights with Image-Based Portion-Size Automated Estimation and Adolescents’ Self-Reported Portion Size (Lee et al. 2012)}\\
...
\textbf{Accuracy of food portion size estimation from digital pictures acquired by a chest-worn camera (Jia et al. 2013)}\\
