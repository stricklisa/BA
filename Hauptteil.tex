...
Der Verzehrshäufigkeitsfragebogen (Food-Frequency Questionnaire) dient der Erfassung von Ernährungsgewohnheiten oder -verhalten und ist im Rahmen epidemiologischer Studien die am meisten eingesetzte Erhebungsmethode (Kirch, 2005). 
...
\begin{figure}[h]
    ...
    \subfloat{	\includegraphics[width=200px]{Bilder/MMM.jpg}}
	\subfloat{	\includegraphics[width=200px]{Bilder/MMM2.jpg}}
	\caption[Screenshot der MMM Homepage]{Screenshot der MMM Homepage. Quelle: Carter et al., 2013a}
	\label{bild2}
\end{figure}

%Abb 2: Screenshot der MMM Homepage. Quelle: Carter et al., 2013a
...
%\caption[Übersicht der in Kapitel 3 vorgestellten Studien]{Hallo}
\includepdf[
  fitpaper,
  addtolist={1, table, {Übersicht der in Kapitel 3 vorgestellten Studien}, tab:Studien}]{Bilder/Tabelle8.pdf}
\end{landscape}
